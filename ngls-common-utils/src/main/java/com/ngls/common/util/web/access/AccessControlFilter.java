...
package com.ngls.common.util.web.access;

import com.google.common.base.Strings;
import com.ngls.common.util.exception.InitializationException;
import com.ngls.common.util.web.http.HttpRequestUtils;
...
public class AccessControlFilter extends OncePerRequestFilter {
    ...
    /**
     * HTTP调试打印开关，true则输出http请求信息
     */
    private boolean logbackHttpDebugEnable;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (logbackHttpDebugEnable) {
            LOG.info(com.ngls.common.util.http.HttpRequestUtils.getRealRemoteAddr(request)
                    + " " + request.getMethod() + " " + request.getRequestURI());
            LOG.info("Parameters: " + com.ngls.common.util.http.HttpRequestUtils.getParameters2Json(request));
            LOG.info("Headers: " + com.ngls.common.util.http.HttpRequestUtils.getHeaders2Json(request));
            LOG.info("Sessions: " + com.ngls.common.util.http.HttpRequestUtils.getSessionAttributes2Json(request));
        }
    ...
    public void setLogbackHttpDebugEnable(boolean logbackHttpDebugEnable) {
        this.logbackHttpDebugEnable = logbackHttpDebugEnable;
    }
}