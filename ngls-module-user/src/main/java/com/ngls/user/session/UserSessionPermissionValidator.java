...
import com.ngls.common.util.web.access.PermissionValidator;
import com.ngls.common.util.web.access.TokenExpiredException;
import com.ngls.common.util.web.access.TokenLoggedOtherException;
import com.ngls.common.util.web.access.TokenRefreshedException;
...
import static com.ngls.user.session.UserSessionComponent.ACCESS_TOKEN_KEY;
import static com.ngls.user.session.UserSessionComponent.SESSION_ID_KEY;
